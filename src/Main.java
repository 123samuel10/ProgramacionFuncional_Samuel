...
public class Main {
    public static void main(String[] args) {
        ...
        while (bandera){
            switch (JOptionPane.showInputDialog("1.elevar edad al cuadrado\n2.filtar nombres mayor a 10 años.\n3.buscar edad de la persona samuel\n4.la suma total de las edades\n5.salir")){
